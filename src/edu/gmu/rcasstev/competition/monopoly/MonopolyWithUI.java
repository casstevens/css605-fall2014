...
import edu.gmu.rcasstev.competition.monopoly.Monopoly.SpaceRecord;
...
public class MonopolyWithUI extends GUIState {
	...
	public void setupGraphs() {
		...
		for (MonopolyPlayer player : monopoly.getPlayers()) {
			...
			XYSeries playerMoneySeries = new XYSeries(player.toString()
					+ " Money");

			XYSeries playerWealthSeries = new XYSeries(player.toString()
					+ " Wealth");
